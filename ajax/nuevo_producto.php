...
include('is_logged.php');//Archivo verifica que el usario que intenta acceder a la URL esta logueado
	...
	if (empty($_POST['codigo'])) {
		...
		$sql="INSERT INTO products (codigo_producto, nombre_producto, date_added, minimo, $localidad, id_categoria) VALUES ('$codigo','$nombre','$date_added','$minimo', '$stock','$id_categoria')";
