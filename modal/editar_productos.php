		...
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax2"></div>
			  ...
			  <div class="form-group">
				<label for="mod_minimo" class="col-sm-3 control-label">Stock minimo</label>
				<div class="col-sm-8">
			 <input type="text" class="form-control" id="mod_minimo" name="mod_minimo" placeholder="StocK" required pattern="^[0-9]{1,5}(\.[0-9]{0,2})?$" title="Ingresa sólo números con 0 ó 2 decimales" maxlength="8">
