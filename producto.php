            ...
            <div class="row">
              <div class="col-sm-4 col-sm-offset-2 text-center">
				 <img class="item-img img-responsive" src="img/stock.png" alt="">
				  <br>
					...
					<a href="#myModal2" data-toggle="modal" data-codigo='<?php echo $row['codigo_producto'];?>' data-nombre='<?php echo $row['nombre_producto'];?>' data-categoria='<?php echo $row['id_categoria']?>' data-minimo='<?php echo $row['minimo']?>' data-stock='<?php echo $row['stock'];?>' data-id='<?php echo $row['id_producto'];?>' class="btn btn-info" title="Editar"> <i class="glyphicon glyphicon-pencil"></i> Editar </a>
              ...
              <div class="col-sm-4 text-left">
                <div class="row margin-btm-20">
                    ...
                    <div class="col-sm-12 margin-btm-10">
                      <span class="item-quantity"><?php echo number_format($row[$localidad]);?></span>
                    </div>
					<div class="col-sm-12">
                      <span class="current-stock"> Stock minimo  </span>
                    </div>
					<div class="col-sm-12">
                      <span class="item-price"> <?php echo number_format($row['minimo']);?></span>
                    </div>
 ...
 var parametros = $(this).serialize();
  ...
  event.preventDefault();
	...
	$('#myModal2').on('show.bs.modal', function (event) {
		...
		modal.find('.modal-body #mod_minimo').val(minimo)
